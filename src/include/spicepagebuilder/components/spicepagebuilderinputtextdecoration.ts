 ...
 */
@Component({
    selector: 'spice-page-builder-input-text-decoration',
    templateUrl: '../templates/spicepagebuilderinputtextdecoration.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        {
            multi: true,
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => SpicePageBuilderInputTextDecoration)
        }
    ]
})
export class SpicePageBuilderInputTextDecoration implements ControlValueAccessor {
    /**
