 ...
 */
@Component({
    selector: 'spice-page-builder-input-direction',
    templateUrl: '../templates/spicepagebuilderinputdirection.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        {
            multi: true,
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => SpicePageBuilderInputDirection)
        }
    ]
})
export class SpicePageBuilderInputDirection implements ControlValueAccessor {
    /**
