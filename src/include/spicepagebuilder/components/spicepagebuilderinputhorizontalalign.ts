 ...
 */
@Component({
    selector: 'spice-page-builder-input-horizontal-align',
    templateUrl: '../templates/spicepagebuilderinputhorizontalalign.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        {
            multi: true,
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => SpicePageBuilderInputHorizontalAlign)
        }
    ]
})
export class SpicePageBuilderInputHorizontalAlign implements ControlValueAccessor {
    /**
