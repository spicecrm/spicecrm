 ...
 */
@Component({
    selector: 'spice-page-builder-input-text-transformn',
    templateUrl: '../templates/spicepagebuilderinputtexttransform.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        {
            multi: true,
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => SpicePageBuilderInputTextTransform)
        }
    ]
})
export class SpicePageBuilderInputTextTransform implements ControlValueAccessor {
    /**
