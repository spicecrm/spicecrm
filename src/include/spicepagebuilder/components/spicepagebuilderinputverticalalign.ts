 ...
 */
@Component({
    selector: 'spice-page-builder-input-vertical-align',
    templateUrl: '../templates/spicepagebuilderinputverticalalign.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        {
            multi: true,
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => SpicePageBuilderInputVerticalAlign)
        }
    ]
})
export class SpicePageBuilderInputVerticalAlign implements ControlValueAccessor {
    /**
