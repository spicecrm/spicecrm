 ...
 */
@Component({
    selector: 'spice-page-builder-input-font-weight',
    templateUrl: '../templates/spicepagebuilderinputfontweight.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [
        {
            multi: true,
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => SpicePageBuilderInputFontWeight)
        }
    ]
})
export class SpicePageBuilderInputFontWeight implements ControlValueAccessor {
    /**
