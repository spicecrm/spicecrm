...
@Component({
    ...
    templateUrl: './src/systemcomponents/templates/systemhtmleditor.html',
    styles: [
...
export class SystemHtmlEditor implements AfterViewInit, OnDestroy, OnChanges, OnInit {
    ...
    private stylesheetIdValue: string = '';
    ...
    private oldStylesheetId: string = '';
    ...
    public ngOnChanges() {
        ...
        if ( this.editor && this.editor.getContent() !== this.fieldvalue ) {
            this.editor.setContent(this.fieldvalue);
        }
