...
export class GitPullFromRepository {
   ...
   // public gitLabTokenRegexp: RegExp = new RegExp("(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.{6,})");
    ...
    public loginCheck() {
        ...
        this.tokenCondition = this.loginDetails.token.length > 0 // && this.gitHubTokenRegexp.test(this.loginDetails.token);
