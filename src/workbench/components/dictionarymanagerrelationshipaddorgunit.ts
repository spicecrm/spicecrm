...
export class DictionaryManagerRelationshipAddOrgUnit {
     ...
     */
    public self: ComponentRef<DictionaryManagerRelationshipAddOrgUnit>;
    ...
    public generateRelationshipFields(name: string) {
        this.relationship.rhs_linkname = `${name}_orgunit_link`;
        this.relationship.rhs_relatename = `${name}_orgunit_name`;
        this.relationship.rhs_sysdictionaryitem_id = this.rhsItems.find(i => i.name == name + '_orgunit_id')?.id;
    }
    ...
    public add() {
        ...
        this.relationship.relationship_name = `{tablename}_${this.relationship.relationship_name}_orgunit`;
    ...
    private setDefaultFields() {
        this.relationship.lhs_sysdictionarydefinition_id = this.dictionarymanager.dictionarydefinitions.find(d => d.name == 'OrgUnit').id;
        ...
        this.relationship.relationship_type = 'orgunit';
