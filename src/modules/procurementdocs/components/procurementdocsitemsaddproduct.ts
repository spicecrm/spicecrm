...
export class ProcurementDocsItemsAddProduct extends ObjectModalModuleLookup {
    ...
    constructor(public language: language, public modellist: modellist, public metadata: metadata, public modelutilities: modelutilities, public model: model, public layout: layout, @Optional() public procurementdocrecord: procurementdocrecord) {
    ...
    public productSelected(product) {
        ...
        copyrules = this.metadata.getCopyRules('Products', 'ProcurementDocItems');
        for (let copyrule of copyrules) {
        ...
        itemData.tax_category = this.procurementdocrecord.getTaxCategory(product.taxcategory);
