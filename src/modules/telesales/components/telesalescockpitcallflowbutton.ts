...
@Component({
    selector: 'telesales-cockpitcall-flow-button',
    templateUrl: '../templates/telesalescockpitcallflowbutton.html',
    standalone: false
})

export class TeleSalesCockpitCallFlowButton {
    ...
    public execute() {
        ...
        this.modalservice.openModal('TeleSalesCockpitCallFlowModal', true, this.injector).subscribe(modalRef => {
