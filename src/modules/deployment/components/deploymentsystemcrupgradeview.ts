...
export class DeploymentSystemCRUpgradeView implements OnDestroy, OnInit {
    ...
    public handleListTypeChange(newType: ListTypeI) {
        this.cdRef.detectChanges();
        if (newType.listcomponent != 'DeploymentSystemCRUpgradeView') return;
        this.chooseFields();
        this.getListData();
    }
    ...
    public loadComponentConfig() {
        this.componentconfig = this.metadata.getComponentConfig('DeploymentSystemCRUpgradeView', this.modellist.module);
