...
@Component({
    ...
    templateUrl: './app/modules/questionnaires/templates/questionnaireevaluation.html',
})
export class QuestionnaireEvaluation implements OnInit {

    @ViewChild('destination', {read: ViewContainerRef}) destination: ViewContainerRef;

    @Input() parentdata: any = {};
    @Input() reference_id: string = '';
    @Input() noAnimation = false;
    @Input() usagePrint = false;
    ...
    noEvaluationTypeDefined: boolean = false;
    noParticipationYet: boolean = false;
