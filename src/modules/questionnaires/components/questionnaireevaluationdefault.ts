...
@Component({
    ...
    templateUrl: './app/modules/questionnaires/templates/questionnaireevaluationdefault.html',
})
export class QuestionnaireEvaluationDefault implements AfterViewInit {
