...
import {AfterViewInit, ComponentFactoryResolver, Component, ElementRef, NgModule, HostListener, Renderer, Renderer2, ViewChild, ViewContainerRef, Injectable, Input, Output, EventEmitter, SimpleChanges, OnInit, OnDestroy, OnChanges, ChangeDetectorRef, HostBinding, Pipe, PipeTransform, Optional} from '@angular/core';
