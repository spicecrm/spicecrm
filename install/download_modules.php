...
{$fileMaxSize}
  <table cellspacing="0" width="100%" cellpadding="0" border="0" align="center" class="shell">
    ...
    <tr>
      ...
      {$mod_strings['LBL_MODULE_TITLE']}<br>
                            ...
                            <td>
                                <table width="450" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
                                        ...
                                        <td valign="bottom">
                                            <input class="button paper-button-0" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" id="upload_button" type=button value="{$mod_strings['LBL_LANG_BUTTON_UPLOAD']}"
                                                disabled="disabled"
                    ...
                    <td align="right">
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" class="stdTable">
                            <tr>
                                ...
                                <td>
                                    <input class="button paper-button-0 next" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="submit" name="next" value="{$mod_strings['LBL_NEXT']}" id="button_next2"/>
                                </td>
                            </tr>
                        </table>
                        </form>
