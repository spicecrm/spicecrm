...
<form action="welcome.php" method="post" name="setLang" id="langForm">
  <table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
    ...
    <tr>
      <th style="text-align: center;">{$mod_strings['LBL_LICENSE_ACCEPTANCE']}<br>
      <a href="http://www.spicecrm.io" target="_blank">
      	<IMG width="300" src="include/images/spice_big.png" alt="SugarCRM" border="0"></a>
      </th>
    </tr>
    <tr>
      <td>
        <textarea rows="20" readonly style="width:100%">{$license_file}</textarea>
      </td>
    </tr>
    ...
    <tr>
      <td align=left>
        ...
        <input type="button" class="button paper-button-0" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" name="print_license" id="button_print_license" value="{$mod_strings['LBL_LICENSE_PRINTABLE']}"
    ...
    <tr>
      <td align="right">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="stdTable">
          <tr>
            <td>
                <input class="acceptButton button paper-button-0" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="button" name="goto" value="{$mod_strings['LBL_BACK']}"  id="button_back_license" onclick="document.getElementById('form').submit();" />
                <input class="acceptButton button paper-button-0 next" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="button" name="goto" value="{$mod_strings['LBL_NEXT']}" id="button_next" disabled="disabled" onclick="callSysCheck();"/>
