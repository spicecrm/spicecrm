...
<body onload="javascript:document.getElementById('button_next').focus();">
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
    ...
    {$mod_strings['LBL_INSTALL_TYPE_TITLE']} <br>
    <a href="http://www.spicecrm.io" target=
  "_blank"><IMG width="300" src="include/images/spice_big.png" alt="SpiceCRM" border="0"></a>
        </th>
    </tr>
...
$out .= <<<EOQ2
<tr><thalign="left">{$mod_strings['LBL_INSTALL_TYPE_SUBTITLE']}</th></tr>
        <tr><td width='200'>
      ...
      <td align="right" height="20">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="stdTable">
          <tr>
            ...
            <td><input class="button paper-button-0" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="button" value="{$mod_strings['LBL_BACK']}" id="button_back_installType" onclick="document.getElementById('form').submit();" />
                <input type="hidden" name="goto" value="{$mod_strings['LBL_BACK']}" /></td>
                <td><input class="button paper-button-0 next" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="submit" name="goto" value="{$mod_strings['LBL_NEXT']}" id="button_next" /></td>
          </tr>
        </table>
      </td>
    </tr>
