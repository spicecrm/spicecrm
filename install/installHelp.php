...
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'SpiceCRM Configuration File';
   $help_item->text = <<< HEREDOC_END
...
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'User Name for SpiceCRM';
   $help_item->text = <<< HEREDOC_END
TODO
HEREDOC_END;
...
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'Password for SpiceCRM';
   $help_item->text = <<< HEREDOC_END
TODO
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'Re-Type Password for SpiceCRM';
   $help_item->text = <<< HEREDOC_END
TODO
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'Drop and recreate existing SpiceCRM tables?';
   $help_item->text = <<< HEREDOC_END
TODO
HEREDOC_END;
...
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'SpiceCRM Admin Password';
   $help_item->text = <<< HEREDOC_END
TODO
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'Re-type SpiceCRM Admin Password';
   $help_item->text = <<< HEREDOC_END
TODO
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'Allow SpiceCRM to collect anonymous usage information?';
   $help_item->text = <<< HEREDOC_END
TODO
HEREDOC_END;
   ...
   $help_item = new HelpItem();
   $help_item->title = 'Use a Custom Session Directory for SpiceCRM';
   $help_item->text = <<< HEREDOC_END
TODO
HEREDOC_END;
...
<head>
   ...
   <title>SpiceCRM Install Help</title>
