...
<table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
   ...
   {$mod_strings['LBL_SITECFG_SECURITY_TITLE']} <br>
   <a href="http://www.spicecrm.io" target="_blank"><IMG width="300" src="include/images/spice_big.png" alt="SpiceCRM" border="0"></a></th>
   </tr>
<tr>
    <td>
    {$errors}
...
<tr>
   ...
   <tr>
    <td>
        <input class="button paper-button-0" raised="" role="button" tabindex="0" animated="" aria-disabled="false" elevation="1" type="button" name="goto" value="{$mod_strings['LBL_BACK']}" id="button_back_siteConfig_b" onclick="document.getElementById('form').submit();" />
