...
'</ul></p><br>' . translate('ML_SUGAR_LOADING_POLICY') .  ' <a href=" http://www.spicecrm.io">' . translate('ML_SUGAR_KB') . '</a>.'.
'<br>' . translate('ML_AVAIL_RESTRICTION'). ' <a href=" http://www.spicecrm.io">' . translate('ML_SUGAR_DZ') .  '</a>.<br><br>';
