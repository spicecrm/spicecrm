...
class PackageManagerDisplay{
   ...
   $str = $ss->fetch('ModuleInstall/PackageManager/tpls/PackageForm.tpl');
    ...
    function buildLoginPanel($mod_strings, $display_cancel){
        ...
        $output .= "<div class='bd'><form><table><tr><td>".$mod_strings['LBL_USERNAME']."</td><td><input type='text' name='login_panel_username' id='login_panel_username' value='".$credentials['username']."'></td><td><a href='http://www.spicecrm.io' target='blank'>".$mod_strings['LNK_NEW_ACCOUNT']."</a></td>";

        $output .= "</tr><tr><td>".$mod_strings['LBL_PASSWORD']."</td><td><input type='password' name='login_panel_password' id='login_panel_password'></td><td><a href='http://www.spicecrm.io' target='blank'>".$mod_strings['LNK_FORGOT_PASS']."</a></td>";
