    ...
    protected function _getCSS()
    {
        return <<<EOCSS
            <style>
                ...
                span.collapse{
                    background: transparent url('index.php?entryPoint=getImage&themeName=SpiceTheme&themeName=SpiceTheme&imageName=sugar-yui-sprites.png') no-repeat 0 -90px;
                    padding-left: 10px;
                    cursor: pointer;
                }

                span.expand{
                    background: transparent url('index.php?entryPoint=getImage&themeName=SpiceTheme&themeName=SpiceTheme&imageName=sugar-yui-sprites.png') no-repeat -0 -110px;
                    padding-left: 10px;
                     cursor: pointer;
                }
                .removeButton{
...
document.getElementById('addrow').onclick = function(){
    ...
    imgButton.src = "index.php?entryPoint=getImage&themeName=SpiceTheme&imageName=id-ff-remove.png";
