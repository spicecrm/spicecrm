...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		...
		<td>
			<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="button primary" onclick="document.ConfigureSettings.action.value='Save';if(verify_data(document.ConfigureSettings)) document.ConfigureSettings.submit();" type="submit" name="buttonSave" id="btn_save" value=" {$APP.LBL_SAVE_BUTTON_LABEL} ">
			<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" class="button" onclick="window.history.back();" type="submit" name="buttonCancel" value=" {$APP.LBL_CANCEL_BUTTON_LABEL} ">
		</td>
