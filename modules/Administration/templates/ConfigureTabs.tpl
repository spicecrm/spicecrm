...
<script type="text/javascript">
	...
	SUGAR.enabledTabsTable = new YAHOO.SUGAR.DragDropTable(
		"enabled_div",
		[{key:"label",  label: lblEnabled, width: 200, sortable: true},
	...
	SUGAR.disabledTabsTable = new YAHOO.SUGAR.DragDropTable(
		"disabled_div",
		[{key:"label",  label: lblDisabled, width: 200, sortable: true},
	...
	SUGAR.subEnabledTable = new YAHOO.SUGAR.DragDropTable(
		...
		[{key:"label",  label: lblSubEnabled, width: 200, sortable: true},
	...
	SUGAR.subDisabledTable = new YAHOO.SUGAR.DragDropTable(
		...
		[{key:"label",  label: lblSubDisabled, width: 200, sortable: true},
