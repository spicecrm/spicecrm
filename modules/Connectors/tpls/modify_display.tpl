...
<tr><td>
<input id="connectors_top_save" title="{$APP.LBL_SAVE_BUTTON_LABEL}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="button" onclick="calculateValues();document.getElementsByName('ModifyDisplay')[0].submit();" type="submit" value="{$APP.LBL_SAVE_BUTTON_LABEL}">
...
<table border="0" class="actionsContainer">
<tr><td>
<input id="connectors_bottom_save" title="{$APP.LBL_SAVE_BUTTON_LABEL}" class="button" onclick="calculateValues();document.getElementsByName('ModifyDisplay')[0].submit();" type="submit" value="{$APP.LBL_SAVE_BUTTON_LABEL}">
