...
//BEGIN Smarty 3 COMPAT: generate buttons here and not in template
$APP = $GLOBALS['app_strings'];
$APPBUTTONS = array(    
    '<input title="'.$GLOBALS['app_strings']['LBL_EDIT_BUTTON_TITLE'].'" accessKey="'.$GLOBALS['app_strings']['LBL_EDIT_BUTTON_KEY'].'" class="button" onclick="var _form = $(\'#form\')[0]; _form.action.value=\'EditView\'; _form.submit();" type="submit" name="button" value="'.$GLOBALS['app_strings']['LBL_EDIT_BUTTON'].'" />',
    '<input title="'.$GLOBALS['app_strings']['LBL_DUPLICATE_BUTTON_TITLE'].'" accessKey="'.$GLOBALS['app_strings']['LBL_DUPLICATE_BUTTON_KEY'].'" class="button" onclick="this.form.isDuplicate.value=\'1\'; this.form.action.value=\'EditView\'" type="submit" name="button" value="'.$GLOBALS['app_strings']['LBL_DUPLICATE_BUTTON'].'" />',
    '<input title="'.$GLOBALS['app_strings']['LBL_DELETE_BUTTON_TITLE'].'" accessKey="'.$GLOBALS['app_strings']['LBL_DELETE_BUTTON_KEY'].'" class="button" onclick="this.form.return_module.value=\'ACLRoles\'; this.form.return_action.value=\'index\'; this.form.action.value=\'Delete\'; return confirm(\''.$GLOBALS['app_strings']['NTC_DELETE_CONFIRMATION'].'\')" type="submit" name="button" value="'.$GLOBALS['app_strings']['LBL_DELETE_BUTTON'].'" />'
);

$sugar_smarty->assign('APPBUTTONS', explode("", $APPBUTTONS));
//END
