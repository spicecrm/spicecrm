...
<form name="ConfigureSettings" enctype='multipart/form-data' method="POST" action="index.php"
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        <tr>
            <th align="left" scope="row" colspan="4"><h4>{$MOD.FTS}</h4></th>
        </tr>
        <tr>
            <td scope="row">{$MOD.LBL_FTS_SERVER}:</td>
            <td>
                <input type='text' size='50' name='fts.server' value='{$config.fts.server}'>
            </td>
            <td scope="row">{$MOD.LBL_FTS_PREFIX}:</td>
            <td>
                <input type='text' size='50' name='fts.prefix' value='{$config.fts.prefix}'>
            </td>
        </tr>
        <tr>
            <td scope="row">{$MOD.LBL_FTS_PORT}:</td>
            <td>
                <input type='text' size='5' name='fts.port' value='{$config.fts.port}'>
            </td>
            <td scope="row"></td>
            <td></td>
        </tr>
