...
//securitysuite_shared_calendar_hide_restricted
$securitysuite_shared_calendar_hide_restricted = '';
if(isset($sugar_config['securitysuite_shared_calendar_hide_restricted']) && $sugar_config['securitysuite_shared_calendar_hide_restricted'] == true) {
    $securitysuite_shared_calendar_hide_restricted = 'CHECKED';
} 
$xtpl->assign('securitysuite_shared_calendar_hide_restricted', $securitysuite_shared_calendar_hide_restricted);
