...
<td>
	...
	<td valign="top" ><slot><input id='duration_hours' name='duration_hours' tabindex="2" size='2' maxlength='2' type="text" value='{$DURATION_HOURS}'> <select tabindex="2" id='duration_minutes' name='duration_minutes'>{$DURATION_MINUTES_OPTIONS}</select> {$MOD.LBL_HOURS_MINUTES}</slot></td>
	</tr>
	</table>
	</form>
