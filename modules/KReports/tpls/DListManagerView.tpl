...
<script type="text/javascript" src="modules/KReports/js/KReporterDListManager.js?{php}rand(100, 900){/php}"></script>
<div style="width: 100%;height:calc(100% - 50px)" id="kreportdlistmanager"></div>
