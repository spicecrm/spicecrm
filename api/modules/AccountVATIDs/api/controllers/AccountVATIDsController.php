...
namespace SpiceCRM\modules\AccountVATIDs\api\controllers;
...
class AccountVATIDsController
{
     ...
     * @return mixed
     */
    public function getSoapBody(Request $req, Response $res, array $args): Response {
