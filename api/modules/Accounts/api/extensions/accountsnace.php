...
use SpiceCRM\modules\Accounts\api\controllers\AccountsNACEController;
 ...
 */
$RESTManager->registerExtension('accountnace', '1.0');
...
$routes = [
    ...
    [
        ...
        'route'       => '/common/nace',
        'class'       => AccountsNACEController::class,
        'function'    => 'postNACECodes',
        'description' => 'posts NACE Codses',
        'options'     => ['noAuth' => false, 'adminOnly' => true, 'validate' => false]
    ],
];
