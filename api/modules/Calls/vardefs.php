...
SpiceDictionaryHandler::getInstance()->dictionary['Call'] = [
    'table'                          => 'calls',
...
if (file_exists("modules/ServiceTickets")) {
    SpiceDictionaryHandler::getInstance()->dictionary['Call']['fields']['servicetickets'] = [
        'name'         => 'servicetickets',
        'type'         => 'link',
...
if (file_exists("extensions/modules/ServiceOrders")) {
    SpiceDictionaryHandler::getInstance()->dictionary['Call']['fields']['serviceorders'] = [
        'name'         => 'serviceorders',
        'type'         => 'link',
...
if (file_exists('extensions/modules/ProjectActivities')) {
    SpiceDictionaryHandler::getInstance()->dictionary['Call']['fields']['projectactivities_parent'] = [
        'name' => 'projectactivities_parent',
        'type' => 'link',
        'relationship' => 'call_projectactivities_parent',
        'source' => 'non-db',
        'module' => 'ProjectActivities',
        'bean_name' => 'ProjectActivity',
        'vname' => 'LBL_PROJECTACTIVITIES_AS_PARENT',
    ];
    SpiceDictionaryHandler::getInstance()->dictionary['Call']['relationships']['call_projectactivities_parent'] = [
        'lhs_module' => 'Calls',
        'lhs_table' => 'calls',
        'lhs_key' => 'id',
