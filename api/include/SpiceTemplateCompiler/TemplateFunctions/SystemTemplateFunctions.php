...
class SystemTemplateFunctions {
    ...
    function cat( $inputstring, $stringToAdd ) {
    ...
    function nl2br( $inputstring ) {
        return nl2br( $inputstring );
    }

    function truncate( $inputstring, $length, $endchars = '' ) {
    ...
    function replace( $inputstring, $needle, $replacement ) {
    ...
    function spacify( $inputstring ) {
        return preg_replace( '#[\w\-](?!$)#', '\\0 ', str_replace( ' ', '   ', $inputstring ));
    }

    function barcode( $inputstring, $type = null, $width = null, $height = null, $color = 'black') {
    ...
    function currentDateTime( $format = null ) {
        if ( !isset( $format[0] )) {
