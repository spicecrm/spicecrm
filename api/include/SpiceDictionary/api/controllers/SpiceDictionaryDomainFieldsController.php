...
/**
 * handles the dictionary domain fields
 *
 * Class SpiceDictionaryDefinitionsController
 */
class SpiceDictionaryDomainFieldsController
{
     ...
     * @return mixed
     */
    public function postDictionaryDomainField(Request $req, Response $res, array $args): Response
    {
        // get the body
