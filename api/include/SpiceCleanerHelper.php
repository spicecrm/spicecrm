...
class SpiceCleanerHelper extends SpiceSingleton
{
    /**
     ...
     * @return string
     */
    static public function stripTags(string $string, bool $encoded = true): string
    {
        return ($encoded) ? DBUtils::toHtml(strip_tags(DBUtils::fromHtml($string))) : strip_tags($string);
    }
}
