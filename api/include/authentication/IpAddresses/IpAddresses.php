...
class IpAddresses
{
    ...
    static function addIpAddress( $color, $description = null, $ipAddress = null, $createdBy = null )
    {
        ...
        return $db->fetchOne("SELECT i.address, i.date_entered, i.created_by, u.user_name as created_by_name, i.description FROM ipaddresses i LEFT JOIN users u ON i.created_by = u.id WHERE date_deleted IS NULL AND address = '".$db->quote( $ipAddress )."'");
    }
