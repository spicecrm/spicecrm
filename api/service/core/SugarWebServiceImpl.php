...
class SugarWebServiceImpl
{
	...
	return $this->get_entries($session, $module_name, [$id], $select_fields, $link_name_to_fields_array);
     ...
     * @exception 'SoapFault' -- The SOAP error, if any
     */
    function get_entry_list($session, $module_name, $query = '', $order_by = '', $offset = 0, $select_fields = [], $link_name_to_fields_array = [], $max_results = 0, $deleted = 0)
    {
