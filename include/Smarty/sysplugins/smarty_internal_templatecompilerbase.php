            ...
            if (strlen($tag) < 6 || substr($tag, - 5) != 'close') {
                    ...
                    if (isset($this->smarty->registered_plugins[$plugin_type][$tag])) {
                        ...
                        if ($plugin_type == Smarty::PLUGIN_COMPILER) {
                            ...
                            if (!is_array($function)) {
                                ...
                                //PHP7 COMPAT
                                //ORIGINAL: $this->smarty->registered_plugins[$plugin_type][$tag][0][0]->$function[1]($new_args, $this);
                                $fn = $function[1];
                                return $this->smarty->registered_plugins[$plugin_type][$tag][0][0]->$fn($new_args, $this);
                            } else {
                    ...
                    if ($found) {
                        ...
                        if ($plugin_type == Smarty::PLUGIN_COMPILER) {
                            ...
                            if (!is_array($function)) {
                                ...
                                //PHP7 COMPAT
                                //ORIGINAL: $this->default_handler_plugins[$plugin_type][$tag][0][0]->$function[1]($new_args, $this);
                                $fn = $function[1];
                                return $this->default_handler_plugins[$plugin_type][$tag][0][0]->$fn($new_args, $this);
                            } else {
                                return call_user_func_array($function, array($new_args, $this));
                            }
                        } else {
                ...
                if (isset($this->smarty->registered_plugins[Smarty::PLUGIN_COMPILER][$tag])) {
                    ...
                    if (!is_array($function)) {
                        ...
                        //PHP7 COMPAT
                        //ORIGINAL: $this->smarty->registered_plugins[Smarty::PLUGIN_COMPILER][$tag][0][0]->$function[1]($args, $this);
                        $fn = $function[1];
                        return $this->smarty->registered_plugins[Smarty::PLUGIN_COMPILER][$tag][0][0]->$fn($args, $this);
                    } else {
